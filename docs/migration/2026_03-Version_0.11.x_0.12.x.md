...
* [Migration Guide `0.11.x -> 0.12.x`](#migration-guide-011x---012x)
  ...
  * [3. Deprecated instances](#3-deprecated-instances)
<!-- TOC -->
...
| Old value                            | New value                                     |
|--------------------------------------|-----------------------------------------------|
| `edc.vault.secrets`                  | `tx.edc.vault.secrets`                        |
...
| Old value                            | New value                               |
|--------------------------------------|-----------------------------------------|
| `tx.iam.iatp.bdrs.server.url`        | `tx.edc.iam.iatp.bdrs.server.url`       |
| `tx.iam.iatp.credentialservice.url`  | `tx.edc.iam.iatp.credentialservice.url` |
| `tx.iam.iatp.bdrs.cache.validity`    | `tx.edc.iam.iatp.bdrs.cache.validity`   |
...
| Old value                             | New value                                     |
|---------------------------------------|-----------------------------------------------|
| `tx.dpf.consumer.proxy.port`          | `tx.edc.dpf.consumer.proxy.port`              |
| `tx.dpf.consumer.proxy.thread.pool`   | `tx.edc.dpf.consumer.proxy.thread.pool`       |
| `edc.api.auth.key.alias`              | `tx.edc.dpf.consumer.proxy.auth.apikey.alias` |
| `edc.api.auth.key`                    | `tx.edc.dpf.consumer.proxy.auth.apikey`       |
...
| Old value                             | New value                                 |
|---------------------------------------|-------------------------------------------|
| `edc.dataplane.token.expiry.tolerance`| `tx.edc.dataplane.token.expiry.tolerance` |
| `edc.dataplane.token.refresh.endpoint`| `tx.edc.dataplane.token.refresh.endpoint` |
| `edc.dataplane.token.expiry`          | `tx.edc.dataplane.token.expiry`           |
...
| Old value              | New value                  |
|------------------------|----------------------------|
| `edc.iam.sts.dim.url`  | `tx.edc.iam.sts.dim.url`   |
...
| Old value                                                  | New value                                  |
|------------------------------------------------------------|--------------------------------------------|
| `org.eclipse.tractusx.edc.postgresql.migration.%s.enabled` | `tx.edc.postgresql.migration.%s.enabled`   |
| `org.eclipse.tractusx.edc.postgresql.migration.schema`     | `tx.edc.postgresql.migration.schema`       |
