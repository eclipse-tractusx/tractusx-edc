...
At the time of writing IDS adds a `securityToken` to each IDS message. This token was generated by the IDS DAPS and authenticates all connectors participating in a data space.
