...
```shell
./mvnw -pl .,edc-controlplane/edc-controlplane-memory-hashicorp-vault -am package -Pwith-docker-image
```

### Configuration (configuration.properties)

Listed below are configuration keys needed to get the `edc-controlplane-memory-hashicorp-vault` up and running.
