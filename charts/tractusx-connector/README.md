...
helm install my-release tractusx-edc/tractusx-connector --version 0.7.3 \
...
| controlplane.catalog | object | `{"crawler":{"initialDelay":null,"num":null,"period":null}}` | configuration for the built-in federated catalog crawler |
