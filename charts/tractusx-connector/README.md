...
![Version: 8.7.6](https://img.shields.io/badge/Version-8.7.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 8.7.6](https://img.shields.io/badge/AppVersion-8.7.6-informational?style=flat-square)
...
helm install my-release tractusx-edc/tractusx-connector --version 8.7.6
```
