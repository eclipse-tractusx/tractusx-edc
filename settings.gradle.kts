...
include(":edc-extensions:dcp:verifiable-presentation-cache:verifiable-presentation-cache-core")
include(":edc-extensions:dcp:verifiable-presentation-cache:verifiable-presentation-cache-api")
