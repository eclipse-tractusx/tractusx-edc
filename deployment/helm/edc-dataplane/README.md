...
**Homepage:** <https://github.com/catenax-ng/product-edc/deployment/helm/edc-dataplane>
...
| image.repository | string | `"ghcr.io/catenax-ng/product-edc/edc-dataplane"` | Which edc-dataplane container image to use |
