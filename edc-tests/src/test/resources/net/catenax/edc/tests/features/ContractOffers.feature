...
#    Then the catalog of connector 'Sokrates' received from 'Plato' contains the following offers
...
#    Then the catalog of connector 'Sokrates' received from 'Plato' does not contain the following offers
#      | source definition     | asset   |
#      | contract-definition-2 | asset-2 |
#
...
#    When 'Sokrates' requests the catalog from 'Plato'
#    Then the catalog of connector 'Sokrates' received from 'Plato' contains '1000' offers
