...
@EndToEndTest
public class PolicyMonitorInMemoryTest extends AbstractPolicyMonitorTest {
    ...
    static void prepare() {
        ...
        SOKRATES_RUNTIME.getContext().getService(Vault.class).storeSecret("test-alias", value);
        PLATO_RUNTIME.getContext().getService(Vault.class).storeSecret("test-alias", value);
    }
}
