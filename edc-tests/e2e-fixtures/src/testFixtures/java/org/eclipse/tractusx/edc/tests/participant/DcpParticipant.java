...
public class DcpParticipant extends TractusxDcpParticipantBase {
    ...
    public static class Builder extends TractusxDcpParticipantBase.Builder<DcpParticipant, Builder> {

        protected Builder() {
            this(new DcpParticipant());
        }

        protected Builder(DcpParticipant participant) {
            super(participant);
        }
