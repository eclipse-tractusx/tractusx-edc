...
@EndToEndTest
public class StsConsumerPullTest extends AbstractDcpConsumerPullTest {
    ...
    @RegisterExtension
    private static final RuntimeExtension CONSUMER_RUNTIME = dcpRuntime(CONSUMER.getName(), CONSUMER.getKeyPair(),
            () -> CONSUMER.dcpConfig().merge(BDRS_SERVER_EXTENSION.getConfig()));

    @RegisterExtension
    private static final RuntimeExtension PROVIDER_RUNTIME = dcpRuntime(PROVIDER.getName(), PROVIDER.getKeyPair(),
