...
import org.eclipse.tractusx.edc.tests.transfer.dcp.dispatchers.DivDispatcher;
...
import static org.eclipse.tractusx.edc.tests.transfer.dcp.runtime.Runtimes.divRuntime;
import static org.mockito.ArgumentMatchers.any;
import static org.mockito.Mockito.mock;
import static org.mockito.Mockito.when;

@EndToEndTest
public class DivConsumerPullTest extends AbstractDcpConsumerPullTest {
    ...
    private static final DcpParticipant CONSUMER = DcpParticipant.Builder.newInstance()
            .name(CONSUMER_NAME)
    ...
    @RegisterExtension
    private static final RuntimeExtension CONSUMER_RUNTIME = divRuntime(CONSUMER.getName(), CONSUMER.getKeyPair(),
            () -> CONSUMER.dcpConfig().merge(BDRS_SERVER_EXTENSION.getConfig()));
    @RegisterExtension
    private static final RuntimeExtension PROVIDER_RUNTIME = divRuntime(PROVIDER.getName(), PROVIDER.getKeyPair(),
    ...
    private static WireMockServer divServer;
    ...
    private static EmbeddedSecureTokenService tokenServiceFor(TokenGenerationService tokenGenerationService, DcpParticipant participant,
