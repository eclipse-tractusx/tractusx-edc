...
public class RemoteParticipantExtension implements BeforeAllCallback, AfterAllCallback {
    ...
    private final DcpParticipant localParticipant;
    private final PostgresExtension postgresql;

    private GenericContainer<?> connector;

    public RemoteParticipantExtension(RemoteParticipant participant, DcpParticipant localParticipant, PostgresExtension postgresql) {
