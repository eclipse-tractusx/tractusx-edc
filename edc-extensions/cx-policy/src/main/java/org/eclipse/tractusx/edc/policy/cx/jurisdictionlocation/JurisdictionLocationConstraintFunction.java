 ...
 */
public class JurisdictionLocationConstraintFunction<C extends ParticipantAgentPolicyContext> extends ValueValidatingConstraintFunction<Permission, C> {
    public static final String JURISDICTION_LOCATION = "JurisdictionLocation";

    public JurisdictionLocationConstraintFunction() {
        super(
                Set.of(Operator.EQ),
                "[\\s\\S]+"
        );
