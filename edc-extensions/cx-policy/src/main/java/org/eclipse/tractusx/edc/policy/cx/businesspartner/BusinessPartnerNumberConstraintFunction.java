...
/**
 * This is a placeholder constraint function for BusinessPartnerNumber. It always returns true but allows
 * the validation of policies to be strictly enforced.
 */
public class BusinessPartnerNumberConstraintFunction<C extends ParticipantAgentPolicyContext> implements AtomicConstraintRuleFunction<Permission, C> {
