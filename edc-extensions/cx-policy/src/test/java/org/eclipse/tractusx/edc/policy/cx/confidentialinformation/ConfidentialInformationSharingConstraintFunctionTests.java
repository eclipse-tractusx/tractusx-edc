...
class ConfidentialInformationSharingConstraintFunctionTests {

    private final ParticipantAgent participantAgent = mock();
    private final ConfidentialInformationSharingConstraintFunction<ParticipantAgentPolicyContext> function = new ConfidentialInformationSharingConstraintFunction<>();
