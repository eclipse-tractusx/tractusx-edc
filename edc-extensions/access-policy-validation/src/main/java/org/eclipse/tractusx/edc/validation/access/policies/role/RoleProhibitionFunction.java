...
package org.eclipse.tractusx.edc.validation.access.policies.role;
...
public class RoleProhibitionFunction extends AbstractRoleValidation
    implements AtomicConstraintFunction<Prohibition> {

  public RoleProhibitionFunction(Monitor monitor) {
    super(monitor);
  }
