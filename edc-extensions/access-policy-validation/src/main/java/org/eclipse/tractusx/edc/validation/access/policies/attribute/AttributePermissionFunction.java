...
/** AtomicConstraintFunction to validate an attribute for edc permissions. */
public class AttributePermissionFunction extends AbstractAttributeValidation
    implements AtomicConstraintFunction<Permission> {

  public AttributePermissionFunction(Monitor monitor) {
    super(monitor);
  }
