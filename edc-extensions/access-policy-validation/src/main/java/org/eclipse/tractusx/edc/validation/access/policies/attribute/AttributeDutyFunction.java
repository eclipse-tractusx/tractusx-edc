...
/** AtomicConstraintFunction to validate an attribute for edc duties. */
public class AttributeDutyFunction extends AbstractAttributeValidation
    implements AtomicConstraintFunction<Duty> {

  public AttributeDutyFunction(Monitor monitor) {
    super(monitor);
  }
