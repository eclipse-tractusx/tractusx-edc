...
package org.eclipse.tractusx.edc.validation.access.policies.attribute;
...
/** AtomicConstraintFunction to validate an attribute for edc prohibitions. */
public class AttributeProhibitionFunction extends AbstractAttributeValidation
    implements AtomicConstraintFunction<Prohibition> {

  public AttributeProhibitionFunction(Monitor monitor) {
    super(monitor);
  }
