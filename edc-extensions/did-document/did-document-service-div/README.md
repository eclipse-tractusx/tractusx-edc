# did-document-service-div

## Overview
This extension provides a client for managing DID Document Service entries using the DIV (Decentralized Identity Verification) API.
...
- **Endpoint:** `PATCH {divUrl}/api/v2.0.0/companyIdentities/{companyIdentityId}`
...
- **Endpoint:** `PATCH {divUrl}/api/v2.0.0/companyIdentities/{companyIdentityId}/status`
...
- **Endpoint:** `GET {divUrl}/api/v2.0.0/companyIdentities?$filter=issuerDID eq "{ownDid}"`
