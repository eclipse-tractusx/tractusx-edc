...
public class TestParticipantAgentPolicyContext extends PolicyContextImpl implements ParticipantAgentPolicyContext {

    private final ParticipantAgent participantAgent;

    public TestParticipantAgentPolicyContext(ParticipantAgent participantAgent) {
