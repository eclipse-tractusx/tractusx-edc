 ...
 */
@Deprecated(since = "0.11.0")
public class BusinessPartnerNumberPermissionLegacyFunction<C extends ParticipantAgentPolicyContext> implements AtomicConstraintRuleFunction<Permission, C> {
