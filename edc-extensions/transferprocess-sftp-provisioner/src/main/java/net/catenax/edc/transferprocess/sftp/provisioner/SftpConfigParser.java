...
public class SftpConfigParser {
    ...
    static List<SftpProvisionerConfiguration> parseConfigurations(Config root) {
        ...
        return configurations.partition()
                .map(config -> {
                    ...
                    final SftpProvisionerConfiguration.ProvisionerType provisionerType = parseProvisionerType(config, provisionerName);
    ...
    private static SftpProvisionerConfiguration.ProvisionerType parseProvisionerType(Config config, String provisionerName) {
        final String typeValue = config.getString(PROVISIONER_TYPE, SftpProvisionerConfiguration.ProvisionerType.PROVIDER.name());
        try {
