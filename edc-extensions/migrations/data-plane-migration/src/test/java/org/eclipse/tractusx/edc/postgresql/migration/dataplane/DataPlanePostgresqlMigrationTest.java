...
public class DataPlanePostgresqlMigrationTest {
    ...
    void shouldRunOnEmptyDatabase(ObjectFactory objectFactory) {
        ...
        var newMigrations = objectFactory.constructInstance(DataPlanePostgresqlMigration.class);
    ...
    private boolean testMigrationHasBeenApplied(Connection connection) throws SQLException {
        return connection.prepareCall("select dummy_column from edc_accesstokendata;").execute();
    }
}
