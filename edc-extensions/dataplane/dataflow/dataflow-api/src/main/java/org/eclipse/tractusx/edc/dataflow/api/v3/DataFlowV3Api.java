...
package org.eclipse.tractusx.edc.dataflow.api.v3;
...
@Tag(name = "DataFlow API V3")
public interface DataFlowV3Api {
    ...
    @Operation(description = "Requests the trigger of a data transfer. " + ASYNC_WARNING,
            responses = {
                    @ApiResponse(responseCode = "204", description = "Request was sucessfully received", links = @Link(name = "poll-state", operationId = "triggerDataTransferV3")),
    ...
    void triggerDataTransferV3(String id);
