...
class AdditionalHeadersProvisionerTest {
    ...
    private final AdditionalHeadersProvisioner provisioner = new AdditionalHeadersProvisioner(HTTP_DATA_TYPE);

    @Test
    void supportedType_shouldReturnHttpData() {
        assertThat(provisioner.supportedType()).isEqualTo(HTTP_DATA_TYPE);
    }
