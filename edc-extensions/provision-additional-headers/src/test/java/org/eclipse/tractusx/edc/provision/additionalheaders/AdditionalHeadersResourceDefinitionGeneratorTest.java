...
class AdditionalHeadersResourceDefinitionGeneratorTest {
    ...
    void shouldCreateResourceDefinitionWithDataAddressAndProperties() {
        ...
        var dataFlow = DataFlow.Builder.newInstance()
                ...
                .properties(Map.of(BPN_PROPERTY, "bpn"))
                .build();
        ...
        assertThat(result)
                ...
                .satisfies(resource -> {
                    ...
                    assertThat(resource.getProperty(AGREEMENT_ID_PROPERTY)).isEqualTo("contractId");
                    assertThat(resource.getProperty(BPN_PROPERTY)).isEqualTo("bpn");
                });
    }
}
