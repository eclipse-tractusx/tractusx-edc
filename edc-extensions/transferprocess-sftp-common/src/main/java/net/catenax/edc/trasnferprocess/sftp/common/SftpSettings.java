...
public interface SftpSettings {
    ...
    @EdcSetting
    String SFTP_USER_PASSWORD = "edc.transfer.sftp.user.password";

    @EdcSetting
    String SFTP_USER_KEY_PATH = "edc.transfer.sftp.user.key.path";

    @EdcSetting
    String SFTP_USER_KEY_PASSPHRASE = "edc.transfer.sftp.user.key.passphrase";
}
