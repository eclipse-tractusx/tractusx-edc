...
public class DataEncryptionExtension implements ServiceExtension {
    ...
    private static final CryptoKeyFactory CRYPTO_KEY_FACTORY = new CryptoKeyFactoryImpl();
    ...
    public void start() {
        ...
        if (DataEncrypterFactory.AES_ALGORITHM.equals(algorithm)) {
            ...
            try {
                final AesKeyProvider aesKeyProvider = new AesKeyProvider(vault, keyAlias, CRYPTO_KEY_FACTORY);
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        final DataEncrypterFactory factory = new DataEncrypterFactory(vault, monitor, CRYPTO_KEY_FACTORY);
        ...
        if (DataEncrypterFactory.NONE.equalsIgnoreCase(algorithm)) {
            ...
            final String msg = String.format(DataEncryptionExtension.EXTENSION_NAME + ": Unsupported encryption algorithm '%s'. Supported algorithms are '%s',  '%s'.",
                    algorithm,
