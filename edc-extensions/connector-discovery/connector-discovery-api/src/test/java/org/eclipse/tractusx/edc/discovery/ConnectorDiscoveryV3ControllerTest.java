...
class ConnectorDiscoveryV3ControllerTest extends RestControllerTestBase {
    ...
    protected Object controller() {
        return new ConnectorDiscoveryV3Controller(connectorService, transformerRegistry, validator, monitor);
    }
    ...
    private RequestSpecification baseRequest(String path) {
        return given()
                ...
                .basePath("/v3/connectordiscovery" + path)
                .when();
    }
}
