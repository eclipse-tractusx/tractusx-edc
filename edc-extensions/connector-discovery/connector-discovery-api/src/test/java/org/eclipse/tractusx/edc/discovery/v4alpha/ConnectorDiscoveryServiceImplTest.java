...
class ConnectorDiscoveryServiceImplTest {
    ...
    void discoverVersionParams_shoudReturnDsp08_whenDidCantBeResolvedAndDsp08Available() {
        ...
        var expectedJsonArray = Json.createObjectBuilder()
                ...
                .add(CATALOG_REQUEST_COUNTER_PARTY_ADDRESS, "someAddress/")
                .build();
    ...
    @Test
    void discoverVersionParams_shouldThrowBadGateway_whenMetadataEndpointHasError() {
        var paramsDiscoveryRequest = new ConnectorParamsDiscoveryRequest("someBpnl", "someAddress");
        ...
        assertThatThrownBy(() -> service.discoverVersionParams(paramsDiscoveryRequest))
                .isInstanceOf(BadGatewayException.class)
                .hasMessageContaining("Counter party well-known endpoint has failed:");
    }

    @Test
    void discoverVersionParams_shouldThrowBadGateway_whenMetadataEndpointIsNotAvailable() {
        var paramsDiscoveryRequest = new ConnectorParamsDiscoveryRequest("someBpnl", "someAddress");
        ...
        assertThatThrownBy(() -> service.discoverVersionParams(paramsDiscoveryRequest))
                .isInstanceOf(BadGatewayException.class)
                .hasMessageContaining("Metadata endpoint not available");
    }
