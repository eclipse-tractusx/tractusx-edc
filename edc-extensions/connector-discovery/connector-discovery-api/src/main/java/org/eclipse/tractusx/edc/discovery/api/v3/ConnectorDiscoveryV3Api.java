...
public interface ConnectorDiscoveryV3Api {
    ...
    void discoverDspVersionParamsV3(JsonObject querySpecJson, @Suspended AsyncResponse response);
    ...
    void discoverConnectorServicesV3(JsonObject querySpecJson, @Suspended AsyncResponse response);
