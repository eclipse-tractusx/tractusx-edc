...
class PolicyValidationExtensionTest {

  private PolicyValidationExtension extension;
  ...
  void setup() {
    ...
    extension = new PolicyValidationExtension(ruleBindingRegistry, policyEngine);
  }
  ...
  void testRegisterDutyFunction() {
    ...
    Mockito.verify(policyEngine, Mockito.times(1))
        .registerFunction(
            ...
            Mockito.eq(PolicyValidationExtension.BUSINESS_PARTNER_CONSTRAINT_KEY),
            Mockito.any());
  }
